...
const commonMotionProps: MotionProps = {
  ...
  animate: {
    ...
    opacity: [0.5, 1, 0.5, 1, 0.5], // Add an array of values for opacity
    transition: {
...
export function RedirectButton() {
  return (
    <a href="/search">
      <button className="animate flex items-center justify-center gap-2.5 rounded-lg border border-border bg-background p-0.5 pr-2">

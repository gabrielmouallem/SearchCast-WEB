export function PrivacyPolicyContent() {
  return (
    <div className="mx-auto mt-14 max-w-screen-md p-10">
      ...
      <p className="mb-4">
        A sua privacidade é importante para nós. É política do site SearchCast
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site{" "}
        <a
          href="https://searchcast.app"
          target="_blank"
      ...
      <p className="mb-4">
        ...
        garantias de privacidade, confidencialidade, retenção, proteção aos
        direitos fundamentais de liberdade e o livre desenvolvimento da
        personalidade da pessoa. Além disso, respeitamos a Constituição Federal
        da República Federativa do Brasil, o Código de Defesa do Consumidor (Lei
      ...
      <p className="mb-4">
        Deixamos claro o motivo que estamos coletando e como será usado, pois
        tudo é feito para correta administração geral.
      </p>
      ...
      <p className="mb-4">
        ...
        com terceiros, exceto por determinação judicial.
      </p>

      <p className="mb-4">
        O nosso site pode ter links para sites externos que não são operados por
        nós. Diante disto, não nos responsabilizamos por danos de terceiros.
        Esteja ciente de que não temos controle sobre o conteúdo e práticas de
        sites de terceiros e não podemos aceitar responsabilidade por suas
      ...
      <p className="mb-4">Nossa política é atualizada de forma constante.</p>

      <p className="mb-4">
        Fica, desde já, o titular de dados ciente que o conteúdo desta Política
        de Privacidade pode ser alterado a critério do site SearchCast,
        independente de aviso ou notificação. Em caso de alteração, as
        modificações produzem todos os efeitos a partir do momento da
        disponibilização no site.
      </p>

      <p className="mb-4">
        O site SearchCast não se responsabiliza caso você venha utilizar seus
        dados de forma incorreta ou inverídica, ficando excluído de qualquer
        responsabilidade neste sentido.
      </p>

      <h2 className="mb-4 mt-8 text-2xl font-bold">Política de Cookies</h2>

      <h3 className="mb-2 mt-6 text-xl font-bold">O que são cookies?</h3>
      <p className="mb-4">
      ...
      <h3 className="mb-2 mt-6 text-xl font-bold">Como usamos os cookies?</h3>
      <p className="mb-4">
      ...
      <h3 className="mb-2 mt-6 text-xl font-bold">Desativar cookies</h3>
      <p className="mb-4">
      ...
      <h3 className="mb-2 mt-6 text-xl font-bold">Cookies que definimos</h3>
      <ul className="mb-4 list-inside list-disc">
        <li className="mb-2">
          <strong>Cookies relacionados a boletins por e-mail:</strong> Este site
          oferece serviços de assinatura de boletim informativo ou e-mail e os
        ...
        <li className="mb-2">
          ...
          usuários com mais precisão. Essas pesquisas podem usar cookies para
          lembrar quem já participou numa pesquisa ou para fornecer resultados
          precisos após a alteração das páginas.
        </li>
        <li className="mb-2">
          <strong>Cookies relacionados a formulários:</strong> Quando você envia
          dados por meio de um formulário como os encontrados nas páginas de
          contato ou nos formulários de comentários, os cookies podem ser
        ...
        <li className="mb-2">
          ...
          usa. Para lembrar suas preferências, precisamos definir cookies para
          que essas informações possam ser chamadas sempre que você interagir
          com uma página que for afetada por suas preferências.
        </li>
      </ul>

      <h3 className="mb-2 mt-6 text-xl font-bold">Cookies de Terceiros</h3>
      <p className="mb-4">
      ...
      <h3 className="mb-2 mt-6 text-xl font-bold">Compromisso do Usuário</h3>

      <p className="mb-4">
        O usuário se compromete a fazer uso adequado dos conteúdos e da
        informação que o site SearchCast oferece e com caráter enunciativo, mas
        não limitativo:
      </p>
      ...
      <ul className="mb-4 list-inside list-disc">
        ...
        <li className="mb-2">
          B{")"} Respeito a todas as legislações nacionais ou internacionais em
          que o Brasil é signatário;
        </li>
        <li className="mb-2">
          C{")"} Não difundir propaganda ou conteúdo de natureza racista,
          xenofóbica, casas de apostas, jogos de sorte e azar, qualquer tipo de
        ...
        <li className="mb-2">
          ...
          (softwares) do site SearchCast, de seus fornecedores ou terceiros,
        ...
        <li className="mb-2">
          ...
          propriedade intelectual reservados, conforme estabelece a Lei de
          Direitos Autorais n. 9.610, de 19.2.1998 do Governo Federal Brasileiro
          e correlatas. Qualquer infringência, serão comunicados às autoridades
          competentes.
        </li>
      </ul>
      ...
      <p className="mb-4">
        ...
        SearchCast, através do canal específico de tratamento, a qualquer
        momento, mediante requisição formal, informações referentes aos seus
        dados.
      </p>
      <p className="mb-4">
        Os pedidos serão analisados conforme previsto em legislação vigente
        dentro de um prazo de 72 horas, salvo determinação legal e/ou objeto de
        lei.
      </p>
      ...
      <ul className="mb-4 list-inside list-disc">
        <li className="mb-2">
          Para alterar seus dados pessoais acesse a opção {'"Acessar"'};
        </li>
        <li className="mb-2">
          Se não quiser receber nossas comunicações de marketing, pode cancelar
          os próximos envios clicando no link enviado junto ao e-mail de
          marketing;
        </li>
        <li className="mb-2">
          Para mudar suas preferências em relação às notificações (incluindo as
          comunicações de marketing) acesse a opção {'"Acessar"'};
        </li>
        <li className="mb-2">
          Para as demais solicitações em relação aos direitos do titular de
          dados pessoais, entre em contato conosco através do e-mail
          contato@searchcast.app;
        </li>
      </ul>

      <h2 className="mb-4 mt-8 text-2xl font-bold">Mais informações</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        O site SearchCast empregará esforços para resguardar as informações e
        dados coletados do usuário pelo site. Todavia, considerando que não há
        meio de transmissão e retenção de dados eletrônicos plenamente eficaz e
        seguro, o site SearchCast não pode assegurar que terceiros não
        autorizados não logrem êxito no acesso indevido, eximindo-se de qualquer
        responsabilidade por danos e prejuízos decorrentes da conduta de
        terceiros, ataques externos ao site como: vírus, invasão ao banco de
        dados, vícios ou defeitos técnicos, assim como operacionais resultante
        da utilização do site e em razão de falhas de conexão.
      </p>
    </div>
  );
}

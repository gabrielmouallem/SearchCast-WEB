export function GuideContent() {
  return (
    <div className="mx-auto mt-14 max-w-screen-md p-10">
      <h1 className="mb-4 text-3xl font-bold">Sobre a Plataforma</h1>
      ...
      <p className="mb-4">
        ...
        <a
          href="https://searchcast.app/onboarding"
          target="_blank"
      ...
      <p className="mb-4">
        Todos os podcasts disponíveis na plataforma incluem:
      </p>
      ...
      <h2 className="mb-4 text-2xl font-bold">Evite Palavras Auxiliares</h2>
      <p className="mb-4">
      ...
      <h2 className="mb-4 text-2xl font-bold">Prefira o Singular</h2>
      <p className="mb-4">
      ...
      <h2 className="mb-4 text-2xl font-bold">Simplifique Termos Técnicos</h2>
      <p className="mb-4">
        Torne termos técnicos mais acessíveis. Exemplo: {'"maior salario"'} ao
        invés de {'"salarios mais altos"'}.
      </p>

      <h2 className="mb-4 text-2xl font-bold">Uniformidade na Escrita</h2>
      <p className="mb-4">
